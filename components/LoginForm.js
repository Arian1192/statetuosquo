            ...
            <div className="w-full max-w-xs">
                <form className="px-10 pt-6 pb-8 mb-4 border rounded shadow-lg dark:shadow-xs border-zinc-200 dark:border-gray-600 dark:shadow-black"
                    ...
                    <div className="mb-4">
                        ...
                        <input className="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none dark:text-white focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username" {...register("username", { required: true })} />
                    ...
                    <div className="mb-6">
                        ...
                        <input className="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none dark:text-white focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************" {...register("password", { required: true })} />
